...
Route::get('/moniteur/Accueil/{id?}','Moniteur\AccueilController@index');
Route::get('/moniteur/Auto_ecole/{id1?}','Moniteur\Auto_ecoleController@index');
Route::get('/moniteur/Candidat/{id1?}','Moniteur\CandidatController@index');
Route::get('/moniteur/Examen_pratique_circuit/{id?}/{id1?}','Moniteur\Examen_pratique_circuitController@index');
Route::get('/moniteur/Examen_pratique_creno/{id?}/{id1?}','Moniteur\Examen_pratique_crenoController@index');
Route::resource('/moniteur/destroy_candidat/{id?}/{id1?}/','Moniteur\CandidatController@destroy');
Route::get('/moniteur/Vehicule/{id1?}','Moniteur\VehiculeController@index');
Route::get('/moniteur/Alerte_Vidange/{id1?}','Moniteur\Alerte_VidangeController@index');
Route::post('/moniteur/store_Alerte_Vidange/{id?}/{id1?}','Moniteur\Alerte_VidangeController@store');
Route::patch('/moniteur/update_Alerte_Vidange/{id?}/{id1?}/','Moniteur\Alerte_VidangeController@update');
Route::resource('/moniteur/destroy_Alerte_Vidange/{id?}/{id1?}/','Moniteur\Alerte_VidangeController@destroy');
Route::get('/moniteur/Alerte_V/{id1?}','Moniteur\Alerte_VController@index');
Route::post('/moniteur/store_Alerte_V/{id?}/{id1?}','Moniteur\Alerte_VController@store');
Route::patch('/moniteur/update_Alerte_V/{id?}/{id1?}/','Moniteur\Alerte_VController@update');
Route::resource('/moniteur/destroy_Alerte_V/{id?}/{id1?}/','Moniteur\Alerte_VController@destroy');


Route::get('/moniteur/Alerte_A/{id1?}','Moniteur\Alerte_AController@index');
Route::post('/moniteur/store_Alerte_A/{id?}/{id1?}','Moniteur\Alerte_AController@store');
Route::patch('/moniteur/update_Alerte_A/{id?}/{id1?}/','Moniteur\Alerte_AController@update');
Route::resource('/moniteur/destroy_Alerte_A/{id?}/{id1?}/','Moniteur\Alerte_AController@destroy');

Route::get('/moniteur/Plan_Seance_Pratique/{id1?}','Moniteur\Plan_Seance_PratiqueController@index');
Route::post('/moniteur/store_Plan_Seance_Pratique/{id?}/{id1?}','Moniteur\Plan_Seance_PratiqueController@store');
Route::patch('/moniteur/update_Plan_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Plan_Seance_PratiqueController@update');
Route::resource('/moniteur/destroy_Plan_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Plan_Seance_PratiqueController@destroy');
Route::resource('/moniteur/active_Plan_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Plan_Seance_PratiqueController@active');


Route::get('/moniteur/Active_Seance_Pratique/{id1?}','Moniteur\Active_Seance_PratiqueController@index');
Route::post('/moniteur/store_Active_Seance_Pratique/{id?}/{id1?}','Moniteur\Active_Seance_PratiqueController@store');
Route::patch('/moniteur/update_Active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Active_Seance_PratiqueController@update');
Route::resource('/moniteur/destroy_Active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Active_Seance_PratiqueController@destroy');
Route::resource('/moniteur/non_active_Active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Active_Seance_PratiqueController@non_active');

Route::get('/moniteur/Non_active_Seance_Pratique/{id1?}','Moniteur\Non_active_Seance_PratiqueController@index');
Route::post('/moniteur/store_Non_active_Seance_Pratique/{id?}/{id1?}','Moniteur\Non_active_Seance_PratiqueController@store');
Route::patch('/moniteur/update_Non_active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Non_active_Seance_PratiqueController@update');
Route::resource('/moniteur/destroy_Non_active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Non_active_Seance_PratiqueController@destroy');
Route::resource('/moniteur/non_active1_Non_active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Non_active_Seance_PratiqueController@non_active1');
Route::resource('/moniteur/active_Non_active_Seance_Pratique/{id?}/{id2?}/{id1?}/','Moniteur\Non_active_Seance_PratiqueController@active');