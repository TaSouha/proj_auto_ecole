...
<form action="/proj_auto_ecole/public/store_candidat" method="POST" class="remove-record-model">
    ...
    <div id="custom-width-modala{{$value->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" style="width:55%;">
            <div class="modal-content">
                ...
                {!! Form::open(['method' => 'DELETE','url' => ['destroy_candidat', $value->id],'style'=>'display:inline']) !!}
                <div class="modal-body">
...
<form action="/proj_auto_ecole/public/update_candidat/{{$value->id}}" method="POST" class="remove-record-model">
