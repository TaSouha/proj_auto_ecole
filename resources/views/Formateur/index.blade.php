       ...
       <li >
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="/proj_auto_ecole/public/formateur"><i class="fa fa-circle-o"></i> Formateurs </a></li>
...
<button  class="btn btn-success btn-sm"  data-toggle="modal" data-url=""  data-target="#custom-width-modald"> <i class="glyphicon glyphicon-plus"></i></button>
        </th>
...
<form action="/proj_auto_ecole/public/store_formateur" method="POST" class="remove-record-model">
...
{!! Form::open(['method' => 'DELETE','url' => ['destroy_formateur', $value->id],'style'=>'display:inline']) !!}
...
<form action="/proj_auto_ecole/public/update_formateur/{{$value->id}}" method="POST" class="remove-record-model">
