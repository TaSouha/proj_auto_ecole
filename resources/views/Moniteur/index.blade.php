       ...
       <li >
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/proj_auto_ecole/public/moniteur"><i class="fa fa-circle-o"></i> Moniteurs </a></li>
...
<form action="/proj_auto_ecole/public/store_moniteur" method="POST" class="remove-record-model">
...
{!! Form::open(['method' => 'DELETE','url' => ['destroy_moniteur', $value->id],'style'=>'display:inline']) !!}
...
<form action="/proj_auto_ecole/public/update_moniteur/{{$value->id}}" method="POST" class="remove-record-model">
