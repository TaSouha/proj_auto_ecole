...
@section('content')
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li >
        ...
        <li class="active"><a href="/proj_auto_ecole/public/vehicule"><i class=" fa fa-automobile"></i> <span>Véhicules</span></a></li>
...
<form action="/proj_auto_ecole/public/store_vehicule" method="POST" class="remove-record-model">
...
@endforeach
   ...
   <a class="btn btn-success btn-sm" href="{{url('/index_alerte_vidange',$value->Matricule)}}">
              <i class="glyphicon glyphicon-file"></i></a>
              <a class="btn btn-warning btn-sm" href="{{url('/index_alerte_v',$value->Matricule)}}" >
...
{!! Form::open(['method' => 'DELETE','url' => ['destroy_vehicule', $value->Matricule],'style'=>'display:inline']) !!}
...
<tr id="edit/{{$value->Matricule}}" style="visibility: hidden; display:none;">
                  ...
                  <form action="/proj_auto_ecole/public/update_vehicule/{{$value->Matricule}}" method="POST" >
                 {{ csrf_field() }}
{{ method_field('PATCH') }}
                    <!-- /.form group -->
<th>
