...
<li class="treeview active">
          ...
          <ul class="treeview-menu ">
           ...
           <li class="active" ><a href="/proj_auto_ecole/public/admin/Examen/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Examens théoriques</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Examens théoriques</li>
      </ol>
    </section>
        ...
        <div class="modal-dialog" style="width:25%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="custom-width-modalLabel">Examen théorique 
            <span class="label label-warning">en attente</span>
</h4></center>
                </div>


<form action="/proj_auto_ecole/public/admin/store_Examen/{{$id1}}" method="POST" class="remove-record-model">
...
<!-- Delete Model -->
   ...
   <form action="/proj_auto_ecole/public/admin/destroy_Examen/{{ $value->id}}/{{$id1}}" method="DELETE" data-parsley-validate>
...
<form action="/proj_auto_ecole/public/admin/update_Examen/{{$value->id}}/{{$id1}}" method="POST" class="remove-record-model">
                <div class="modal-body">
                    <h4>
...
<form action="" method="POST" class="remove-record-model">
    ...
    @if($value->Resultat=='Refusé')
     ...
     <td>
        ...
        @if($value->Resultat=="Refusé")
 <a class="btn btn-success btn-sm" href='/proj_auto_ecole/public/admin/admis_Examen/{{$value->id}}/{{$id1}}'>
              <i class="fa fa-check-square-o"></i></a>

       
              @elseif($value->Resultat=="Admis")
                   <a class="btn btn-danger btn-sm" href='/proj_auto_ecole/public/admin/refusé_Examen/{{$value->id}}/{{$id1}}'>
