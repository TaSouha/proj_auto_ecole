...
<li class="treeview active">
          ...
          <ul class="treeview-menu ">
           ...
           <li ><a href="/proj_auto_ecole/public/admin/Examen/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Examens théoriques</span></a></li>
              <li ><a href="/proj_auto_ecole/public/admin/Examen_pratique/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Examens pratiques-circuit</span></a></li>
                   <li class="active" ><a href="/proj_auto_ecole/public/admin/Examen_pratique_créno/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Examens pratiques-créno</span></a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Examens pratiques-créno
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Acceuil </a></li>
        <li class="active">Examens pratiques-créno</li>
      </ol>
    </section>
        ...
        <div class="modal-dialog" style="width:25%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="custom-width-modalLabel">Examen pratique-créno
            <span class="label label-warning">en attente</span>
</h4></center>
                </div>


<form action="/proj_auto_ecole/public/admin/store_Examen_pratique_créno/{{$id1}}" method="POST" class="remove-record-model">
...
<!-- Delete Model -->
   ...
   <form action="/proj_auto_ecole/public/admin/destroy_Examen_pratique_créno/{{ $value->id}}/{{$id1}}" method="DELETE" data-parsley-validate>
...
<form action="/proj_auto_ecole/public/admin/update_Examen_pratique_créno/{{$value->id}}/{{$id1}}" method="POST" class="remove-record-model">
                <div class="modal-body">
                    <h4>
...
<form action="" method="POST" class="remove-record-model">
    ...
    @if($value->Resultat=='Refusé')
     ...
     <td>
        ...
        @if($value->Resultat=="Refusé")
 <a class="btn btn-success btn-sm" href='/proj_auto_ecole/public/admin/admis_Examen_pratique_créno/{{$value->id}}/{{$id1}}'>
              <i class="fa fa-check-square-o"></i></a>

       
              @elseif($value->Resultat=="Admis")
                   <a class="btn btn-danger btn-sm" href='/proj_auto_ecole/public/admin/refusé_Examen_pratique_créno/{{$value->id}}/{{$id1}}'>
