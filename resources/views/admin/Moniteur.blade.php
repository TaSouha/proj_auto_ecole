...
@section('content')
 ...
 <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/proj_auto_ecole/public/admin/Moniteur/{{$id1}}"><i class="fa fa-circle-o"></i> Moniteurs </a></li>
...
<form action="/proj_auto_ecole/public/admin/store_moniteur/{{$id1}}" method="POST" class="remove-record-model">
...
<form action="/proj_auto_ecole/public/admin/destroy_moniteur/{{ $value->id}}/ff/{{$id1}}" method="DELETE" data-parsley-validate>
...
<form action="/proj_auto_ecole/public/admin/update_moniteur/{{$value->id}}/ff/{{$id1}}" method="POST" class="remove-record-model">
