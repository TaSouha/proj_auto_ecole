        ...
        <li ><a href="/proj_auto_ecole/public/admin/Candidat/{{$id1}}"><i class="fa fa-user"></i> <span>Candidats</span></a></li>
          ...
          <ul class="treeview-menu">
           ...
           <li   ><a href="/proj_auto_ecole/public/admin/Seance_Theorique/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Séances théoriques</span></a></li>
              <li class="active"><a href="/proj_auto_ecole/public/admin/Seance_Pratique/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Séances pratiques</span></a></li>
          </ul>
        </li>
...
<form action="/proj_auto_ecole/public/admin/store_Seance_Pratique/{{$id1}}" method="POST" class="remove-record-model">
...
<!-- Delete Model -->
   ...
   <form action="/proj_auto_ecole/public/admin/destroy_Seance_Pratique/{{ $value->id}}/{{$value->id2}}/{{$id1}}" method="DELETE" data-parsley-validate>
...
<form action="/proj_auto_ecole/public/admin/update_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}" method="POST" class="remove-record-model">
                <div class="modal-body">
                    <h4>
