  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Auto écoles</li><li class="active">Dépenses</li>
      </ol>
    </section>
...
<th> Designations</th>
    ...
    <th with="140px" class="text-center">
     <!--<a href="{{url('/create_depense',$id)}}" class="btn btn-success btn-sm">
     </a>-->
...
{!! Form::open(['method' => 'DELETE','url' => ['destroy_depense', $value->id],'style'=>'display:inline']) !!}
...
{{ method_field('PATCH') }}
    ...
    @endforeach   
                ...
                <tr id="create"  style="visibility: hidden; display:none;">
                  ...
                  <form action="/proj_auto_ecole/public/store_depense/{{$id}}" method="POST" >
                    {{ csrf_field() }}
                    <th>    <!-- Date -->
