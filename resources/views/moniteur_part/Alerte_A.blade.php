       ...
       <li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
               ...
               <li class="active"><a href="/proj_auto_ecole/public/moniteur/Alerte_A/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Alerte d'assurance </span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Véhicules</li><li class="active">Alerte d'assurance</li>
      </ol>
    </section>
...
<!-- Delete Model -->
   ...
   <form action="/proj_auto_ecole/public/moniteur/destroy_Alerte_A/{{ $value->id}}/{{$id1}}" method="DELETE" data-parsley-validate>
         ...
         <!-- <a class="btn btn-primary btn-sm" href="{{url('/edit_depense', $value->id)}}">
             ...
             <button class="btn btn-danger btn-sm" data-toggle="modal" data-url="{{url('/destroy_alerte_vidange', $value->id) }}" data-id="{{$value->id}}" data-target="#custom-width-modalb{{$value->id}}"><i class="glyphicon glyphicon-trash"></i></button>
                ...
                <tr id="edit/{{$value->id}}" style="visibility: hidden; display:none;">
                  ...
                  <form action="/proj_auto_ecole/public/moniteur/update_Alerte_A/{{$value->id}}/{{$id1}}" method="POST" >
                 {{ csrf_field() }}
{{ method_field('PATCH') }}
                    <!-- /.form group --></th>
  ...
  <th><textarea name="Description" class="form-control pull-right" value="{{old('Description')}}">{{$value->Description}}</textarea>
    ...
    @endforeach   
                ...
                <thead>
                  ...
                  <form action="/proj_auto_ecole/public/moniteur/store_Alerte_A/{{$Vehicule->Matricule}}/{{$id1}}" method="POST" >
                    {{ csrf_field() }}
                    <!-- /.form group --></th>
                  <th><div class="input-group date"><div class="input-group-addon">
                    <i class="fa fa-calendar-times-o"></i>
