  ...
  <div class="input-group date"><div class="input-group-addon"> 
    ...
    <div id="custom-width-modala{{$value->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" style="width:55%;">
            ...
            <form action="/proj_auto_ecole/public/moniteur/destroy_candidat/{{ $value->id}}/{{$id1}}" method="DELETE" data-parsley-validate>
                <div class="modal-body">
                    <h4>Voulez-vous vraiment supprimer tous les séances pratiques assurées par vous avec ce candidat?</h4>
                </div>
                <div class="modal-footer">
...
<a class="btn btn-success btn-sm" href='/proj_auto_ecole/public/moniteur/Examen_pratique_circuit/{{$value->id}}/{{$id1}}'>
              <i class="glyphicon glyphicon-file"></i></a>
               <a class="btn btn-warning btn-sm" href='/proj_auto_ecole/public/moniteur/Examen_pratique_creno/{{$value->id}}/{{$id1}}'>
