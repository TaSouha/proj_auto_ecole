       ...
       <li >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="/proj_auto_ecole/public/moniteur/Non_active_Seance_Pratique/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Les séances en attente</span></a></li>
          </ul>
        </li>
...
<form action="/proj_auto_ecole/public/moniteur/store_Non_active_Seance_Pratique/{{$id1}}" method="POST" class="remove-record-model">
...
<!-- Delete Model -->
   ...
   <form action="/proj_auto_ecole/public/moniteur/destroy_Non_active_Seance_Pratique/{{ $value->id}}/{{$value->id2}}/{{$id1}}" method="DELETE" data-parsley-validate>
...
<form action="/proj_auto_ecole/public/moniteur/update_Non_active_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}" method="POST" class="remove-record-model">
                <div class="modal-body">
                    <h4>
...
{{ method_field('PATCH') }}
    <div class="input-group date"><div class="input-group-addon" >
     ...
     <td>
           ...
           @if($value->Etat=="non valide")
 <a class="btn btn-success btn-sm" href='/proj_auto_ecole/public/moniteur/active_Non_active_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}'>
              <i class="fa fa-check-square-o"></i></a>

       
              @elseif($value->Etat=="valide")
                   <a class="btn btn-danger btn-sm" href='/proj_auto_ecole/public/moniteur/non_active_Non_active_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}'>
              <i class="fa fa-square-o"></i></a>
        @else
           <a class="btn btn-success btn-sm" href='/proj_auto_ecole/public/moniteur/active_Non_active_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}'>
              <i class="fa fa-check-square-o"></i></a>
                    <a class="btn btn-danger btn-sm" href='/proj_auto_ecole/public/moniteur/non_active1_Non_active_Seance_Pratique/{{$value->id2}}/{{$id1}}'>
              <i class="fa fa-square-o"></i></a>
              @endif
        </td>
</tr>
