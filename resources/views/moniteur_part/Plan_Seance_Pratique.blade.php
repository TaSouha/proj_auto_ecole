       ...
       <li >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              ...
              <li  class="active"><a href="/proj_auto_ecole/public/moniteur/Plan_Seance_Pratique/{{$id1}}"><i class=" fa fa-circle-o"></i> <span>Plan des séances</span></a></li>
...
<form action="/proj_auto_ecole/public/moniteur/store_Plan_Seance_Pratique/{{$id1}}" method="POST" class="remove-record-model">
...
<!-- Delete Model -->
   ...
   <form action="/proj_auto_ecole/public/moniteur/destroy_Plan_Seance_Pratique/{{ $value->id}}/{{$value->id2}}/{{$id1}}" method="DELETE" data-parsley-validate>
...
<form action="/proj_auto_ecole/public/moniteur/update_Plan_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}" method="POST" class="remove-record-model">
                <div class="modal-body">
                    <h4>
...
{{ method_field('PATCH') }}
 ...
 <a class="btn btn-success btn-sm" href='/proj_auto_ecole/public/moniteur/active_Plan_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}'>
              ...
              @elseif($value->Etat=="valide")
                   <a class="btn btn-danger btn-sm" href='/proj_auto_ecole/public/admin/non_active_Seance_Pratique/{{$value->id}}/{{$value->id2}}/{{$id1}}'>
